        ...
        <div class="nav-scroller bg-white shadow-sm">
            <nav class="nav nav-underline">                                
                <li class="nav-item">
                    ...
                    <?= $this->Html->link(__('Edit Product Type'), ['action' => 'edit', $productType->id]) ?> 
                    <?= $this->Form->postLink(__('Delete Product Type'), ['action' => 'delete', $productType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $productType->id)]) ?> 
                    <?= $this->Html->link(__('List Product Types'), ['action' => 'index']) ?> 
                    <?= $this->Html->link(__('New Product Type'), ['action' => 'add']) ?> 
