        ...
        <div class="nav-scroller bg-white shadow-sm">
            <nav class="nav nav-underline">                                
                <li class="nav-item">
                    ...
                    <?= $this->Html->link(__('Edit City'), ['action' => 'edit', $city->id]) ?>
                    <?= $this->Form->postLink(__('Delete City'), ['action' => 'delete', $city->id], ['confirm' => __('Are you sure you want to delete # {0}?', $city->id)]) ?>
                    <?= $this->Html->link(__('List Cities'), ['action' => 'index']) ?>
                    <?= $this->Html->link(__('New City'), ['action' => 'add']) ?>
