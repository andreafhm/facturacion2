        ...
        <div class="nav-scroller bg-white shadow-sm">
            <nav class="nav nav-underline">                                
                <li class="nav-item">
                    ...
                    <?= $this->Html->link(__('Edit Client'), ['action' => 'edit', $client->id]) ?>
                    <?= $this->Form->postLink(__('Delete Client'), ['action' => 'delete', $client->id], ['confirm' => __('Are you sure you want to delete # {0}?', $client->id)]) ?>
                    <?= $this->Html->link(__('List Clients'), ['action' => 'index']) ?>
                    <?= $this->Html->link(__('New Client'), ['action' => 'add']) ?>
