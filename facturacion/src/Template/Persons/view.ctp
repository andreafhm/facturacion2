        ...
        <div class="nav-scroller bg-white shadow-sm">
            <nav class="nav nav-underline">                                
                <li class="nav-item">
                    ...
                    <?= $this->Form->postLink(__('Delete Person'), ['action' => 'delete', $person->id], ['confirm' => __('Are you sure you want to delete # {0}?', $person->id)]) ?>
                    <?= $this->Html->link(__('List Persons'), ['action' => 'index']) ?>
                    <?= $this->Html->link(__('New Person'), ['action' => 'add']) ?>
