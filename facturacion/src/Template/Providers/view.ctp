        ...
        <div class="nav-scroller bg-white shadow-sm">
            <nav class="nav nav-underline">                                
                <li class="nav-item">
                    ...
                    <?= $this->Html->link(__('Edit Provider'), ['action' => 'edit', $provider->id]) ?> 
                    <?= $this->Form->postLink(__('Delete Provider'), ['action' => 'delete', $provider->id], ['confirm' => __('Are you sure you want to delete # {0}?', $provider->id)]) ?> 
                    <?= $this->Html->link(__('List Providers'), ['action' => 'index']) ?> 
                    <?= $this->Html->link(__('New Provider'), ['action' => 'add']) ?> 
