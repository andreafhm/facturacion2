...
<nav class="navbar navbar-expand-sm navbar-dark" style="background: #0c4764;">
        ...
        <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link" href="/~u20180584/facturacion/product-types">List Product Types</a> 
                </li>
                <li class="nav-item">
                <a class="nav-link" href="/~u20180584/facturacion/product-types/add">New Product Type</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link" href="/~u20180584/facturacion/warehouses">List Warehouses</a> 
                </li>
                <li class="nav-item">
                <a class="nav-link" href="/~u20180584/facturacion/warehouses/add">New Warehouse</a> 
                </li>
        </ul>
    ...
    <div class="col-md-12">
        ...
        <div class='page-header'>
            <h3>
                ...
                <?= $this->Html->link($this->Html->tag('i', '', ['class' => 'fa fa-plus']).__('New'), ['controller' => 'Products', 'action' => 'add'], ['class' => 
