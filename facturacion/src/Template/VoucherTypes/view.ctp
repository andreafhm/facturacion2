        ...
        <div class="nav-scroller bg-white shadow-sm">
            <nav class="nav nav-underline">                                
                <li class="nav-item">
                    ...
                    <?= $this->Html->link(__('Edit Voucher Type'), ['action' => 'edit', $voucherType->id]) ?> 
                    <?= $this->Form->postLink(__('Delete Voucher Type'), ['action' => 'delete', $voucherType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $voucherType->id)]) ?> 
                    <?= $this->Html->link(__('List Voucher Types'), ['action' => 'index']) ?> 
                    <?= $this->Html->link(__('New Voucher Type'), ['action' => 'add']) ?> 
