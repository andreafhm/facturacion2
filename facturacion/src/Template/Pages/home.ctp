    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/~u20180584/facturacion/products">Productos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/~u20180584/facturacion/voucher-headers">Comprobantes</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row align-items-center no-gutters mb-4 mb-lg-5">
        ...
        <div class="col-xl-4 col-lg-5">
          <div class="featured-text text-center text-lg-left">
            <h4><a href="/~u20180584/facturacion/products" id="blackHover">Productos</a></h4>
          ...
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-left">
                <h4><a href="/~u20180584/facturacion/voucher-headers" id="whiteHover">Ventas</a></h4>
          ...
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-right">
                <h4><a href="/~u20180584/facturacion/warehouses" id="whiteHover">Almacenes</a></h4>
